import { channelMention, ChannelType, ChatInputCommandInteraction, PermissionFlagsBits, SlashCommandBuilder } from "discord.js";
    ...
    .addSubcommand((subcommand) =>
        subcommand
            ...
            .addChannelOption((option) =>
                option
                    .setName("channel")
                    .setDescription("The channel to use for logging (leave empty to remove the current log channel).")
            )
    )
    .toJSON(),
